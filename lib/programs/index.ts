...
const PROGRAM_IDS: Record<Cluster, Record<string, string>> = {
  devnet: {
    ...
    dwalletGuard: "Bzxgvxp9rZt2qeY7UNnvic9jHQdVFMw7mWzXvjuwLnT2", // Phase 2C — SBF built, IDL generated, deployment pending devnet funds
  },
  localnet: {
    humanRegistry: "GB35h1zNh8WK5c72yVXu6gk6U7eUMFiTTymrXk2dfHHo",
    agentRegistry: "GLrs6qS2LLwKXZZuZXLFCaVyxkjBovbS2hM9PA4ezdhQ",
  ...
  "mainnet-beta": {
    ...
    documentRegistry: "",
    receipts: "",
    dwalletGuard: "Bzxgvxp9rZt2qeY7UNnvic9jHQdVFMw7mWzXvjuwLnT2",
  },
};
