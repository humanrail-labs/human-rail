...
const sdk_1 = require("@humanrail/sdk");
const executor_js_1 = require("./executor.js");
const tools_js_1 = require("./tools.js");
class AgentRuntime {
    constructor(config) {
        this.agent = new sdk_1.HumanRailAgent({
            agentKeypair: config.agentKeypair,
            principalPubkey: config.principalPubkey,
            rpcUrl: config.rpcUrl,
        });
        this.executor = new executor_js_1.ToolExecutor(this.agent);
    ...
    async processMessage(userMessage) {
        ...
        while (maxIterations > 0) {
            ...
            const llmResponse = await this.provider.chat({
                ...
                tools: tools_js_1.HUMANRAIL_TOOLS,
            });
