...
const suggestions = [
  ...
  "Show me what happens if the recipient is not allowed",
      ...
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-1 max-w-2xl text-sm text-neutral-400">
            Talk to a Mandara agent. The agent can prepare signature requests, but only you can approve or reject them.
          </p>
          <p className="mt-2 text-xs text-amber-300">
            Devnet beta · Ika pre-alpha mock signer · Not production custody
          </p>
          <p className="mt-1 text-xs text-neutral-500">
            Natural-language understanding is powered by the Mandara backend. Users do not need to configure model keys.
          </p>
        </div>
      </div>
        ...
        <Card className="border-white/[0.06] bg-white/[0.03]">
          <CardContent className="flex flex-wrap items-center justify-between gap-4 py-5">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-medium text-white">No active Agent found</p>
                <p className="text-xs text-neutral-500">Create an Agent before starting Agent Chat.</p>
              </div>
            </div>
